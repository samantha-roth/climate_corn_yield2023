...
if(dir.exists("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.2/rank20/detrend")==F){
  dir.create("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.2/rank20/detrend")}
...
obsModLinear<- obsNoTimeBIC[1:length(obsModLinear)]
...
#foreach(start = 1:5)%dopar%{
  if(start < 5){
    ...
    if(dir.exists(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.2/rank20/start",start,"/detrend",sep=""))==F){
      dir.create(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.2/rank20/start",start,"/detrend",sep=""))}
    ...
    setwd(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.2/rank20/start",start,"/detrend",sep=""))
    save(res,file="samples_cfmpw_allyrs.RData")
    save(ptFinal,file="time_cfmpw_allyrs.RData")
  ...
  if(start==5){
    ...
    setwd(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.2/rank20/detrend",sep=""))
    save(res,file="samples_cfmpw_allyrs.RData")
    save(ptFinal,file="time_cfmpw_allyrs.RData")
