...
if(dir.exists("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/plots")==F){
  dir.create("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/plots")}

rm(list=ls())
setwd("/storage/work/svr5482")
load("Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/samples_cfmpw_allyrs.RData")
load("Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/time_cfmpw_allyrs.RData")
...
save(allPreds,file="Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/allPreds.RData")
