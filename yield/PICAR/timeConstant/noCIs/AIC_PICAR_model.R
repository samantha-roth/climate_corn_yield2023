...
if(dir.exists("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1")==F){
  dir.create("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1")}

if(dir.exists("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190")==F){
  dir.create("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190")}
...
#setwd(paste("/storage/work/svr5482/Climate_CornYield-me/PICAR/timeConstant/noCIs/cutoff.1/rank190",sep=""))
...
#    if(dir.exists(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/start",start,sep=""))==F){
#      dir.create(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/start",start,sep=""))}
...
#    setwd(paste("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/start",start,sep=""))
#    save(res,file="samples_cfmpw_allyrs.RData")
#    save(ptFinal,file="time_cfmpw_allyrs.RData")
