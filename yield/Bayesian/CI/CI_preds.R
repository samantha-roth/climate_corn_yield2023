...
load("Climate_CornYield-me/yield/Bayesian/CI/output/samples_cfmpw_fast.RData")
load("Climate_CornYield-me/yield/Bayesian/CI/output/time_cfmpw_fast.RData")
...
save(allPreds,file="Climate_CornYield-me/yield/Bayesian/CI/output/allPreds.RData")
