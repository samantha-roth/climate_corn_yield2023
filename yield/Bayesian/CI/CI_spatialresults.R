...
for(i in (ntrainyrs+1):nyrs){
  ...
  if(i<=ntrainyrs){
    ...
    filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/Bayesian/CI/plots/meanpred_train_",1980+i,".jpeg",sep="")
    ...
    a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
      ...
      labs(title = paste("County intercepts: ", 1980+i," yield",sep=""))+
    ...
    filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/Bayesian/CI/plots/resid_train_",1980+i,".jpeg",sep="")
    jpeg(file = filename,width = 800,height=800)
    #res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
    a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                              "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                              "LA","AR","IA"), data=resid.df, values="resid") +
      labs(title = paste("County intercepts: ", 1980+i," yield residual",sep=""))+
      scale_fill_gradient2(low = "blue",mid="white", high ="red", 
  ...
  if(i>ntrainyrs){
    ...
    filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/Bayesian/CI/plots/meanpred_test_",1980+i,".jpeg",sep="")
    jpeg(file = filename,width = 800,height=800)
    #res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
    a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                              "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
    ...
    filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/Bayesian/CI/plots/resid_test_",1980+i,".jpeg",sep="")
    jpeg(file = filename,width = 800,height=800)
    #res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
    a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                              "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
...
for(i in 35:36){
  ...
  filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/Bayesian/CI/plots/meanpred_test_",1980+i,"_MET.jpeg",sep="")
  jpeg(file = filename,width = 800,height=800)
  #res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
  a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                            "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                            "LA","AR","IA"), data=meanpred.df, values="meanpred") +
    labs(title = paste("METDATA: ", 1980+i," yield",sep=""))+
    scale_fill_gradient2(low = "blue",mid="white", high ="red", 
                         limits=c(min_pred,max_pred), 
                         name="bushels/acre")+
    theme(plot.title = element_text(size=28), 
  ...
  filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/Bayesian/CI/plots/resid_test_",1980+i,"_MET.jpeg",sep="")
  jpeg(file = filename,width = 800,height=800)
  #res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
  a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                            "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                            "LA","AR","IA"), data=resid.df, values="resid") +
    labs(title = paste("METDATA: ", 1980+i," yield residual",sep=""))+
    scale_fill_gradient2(low = "blue",mid="white", high ="red", 
                         limits=c(min_resid,max_resid), name="bushels/acre")+
    theme(plot.title = element_text(size=28), 
          legend.text= element_text(size=24),
