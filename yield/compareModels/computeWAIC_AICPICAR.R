...
save(sum_lik,sum_llik,
     file=paste0("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/sum_likAndsum_llik",25,".RData"))
...
foreach(h=remainder)%dopar%{
  ...
  save(sum_lik,sum_llik,
       file=paste0("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/sum_likAndsum_llik",h,".RData"))
}
...
setwd("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190")
load("samples_cfmpw_allyrs.RData")
...
for(h in 0:25){
  load(paste0("/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/sum_likAndsum_llik",h,".RData"))
...
save(WAIC1,file="/storage/work/svr5482/Climate_CornYield-me/yield/PICAR/timeConstant/noCIs/cutoff.1/rank190/WAIC1.RData")
