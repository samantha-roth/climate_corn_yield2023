...
for(i in 1:nCounties){
  ...
  pastCountyMeans[i]<- mean(obsNoTimeCI[fipsinds])
}
...
#  filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/prediction/plots/CIspatialMeanPredAllModels",plotyrs[t],".jpeg",sep="")
...
#    labs(title = paste("CI- ",plotyrs[t]," mean yield projection",sep=""))+
...
filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/prediction/plots/CIspatialMeanPredAllModelsAllYrs_2020_2049.jpeg",sep="")
jpeg(file = filename,width = 800,height=800)
#res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                          "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                          "LA","AR","IA"), data=meanPredAllYrsAllModels.df, values="meanPreds") +
  labs(title = paste("County intercepts: 2020-2049 projected mean yield anomaly",sep=""))+
  scale_fill_gradient2(low = "blue",mid="white", high ="red", 
...
filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/prediction/plots/CIspatialDiffPredAllModelsAllYrs_2020_2049.jpeg",sep="")
jpeg(file = filename,width = 800,height=800)
a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                          "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                          "LA","AR","IA"), data=diffPredAllYrsAllModels.df, values="diffPreds") +
  labs(title = paste("County intercepts: 2020-2049 projected mean change",sep=""))+
  scale_fill_gradient2(low = "blue",mid="white", high ="red", 
...
filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/prediction/plots/CIspatialMeanPredAllModelsAllYrs_2070_2099.jpeg",sep="")
jpeg(file = filename,width = 800,height=800)
#res<- as.data.frame(slr_res.df[which(slr_res.df$year==(1980+i)),])
a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                          "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                          "LA","AR","IA"), data=meanPredAllYrsAllModels.df, values="meanPreds") +
  labs(title = paste("County intercepts: 2070-2099 projected mean yield anomaly",sep=""))+
  scale_fill_gradient2(low = "blue",mid="white", high ="red", 
...
filename<-paste("/storage/work/svr5482/Climate_CornYield-me/yield/prediction/plots/CIspatialDiffPredAllModelsAllYrs_2070_2099.jpeg",sep="")
jpeg(file = filename,width = 800,height=800)
a=plot_usmap(regions="counties",include=c("PA","NY","NJ","MD","DE","DC","NC","VA","SC","WV","OH",
                                          "MI","GA","KY","IN","IL","AL","TN","WI","MS","MN","MO",
                                          "LA","AR","IA"), data=diffPredAllYrsAllModels.df, values="diffPreds") +
  labs(title = paste("County intercepts: 2070-2099 projected mean change",sep=""))+
  scale_fill_gradient2(low = "blue",mid="white", high ="red", 
